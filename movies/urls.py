...
urlpatterns = [
    ...
    path('accounts/password_change', auth_views.PasswordChangeView.as_view(template_name="movies/password_change.html"),
         name="password_change"),
    path('accounts/password_change_done',
         auth_views.PasswordChangeDoneView.as_view(template_name="movies/password_change_done.html"),
